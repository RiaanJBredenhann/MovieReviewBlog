...
export default class MoviesController{
    ...
    // when apiGetMovies is called via a URL, there will be a query string in the response object 
    // (req.query) where certain filter parameters might be specified and passed in through key-value pairs
